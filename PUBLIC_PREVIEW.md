...
|------|------------|-------|
| **https://divided-minimum-eva-therapy.trycloudflare.com** | Hours while workspace is awake | **Latest** — mini-window X / S / L in small Pulse-blue circles. Hard-refresh if stale. |
