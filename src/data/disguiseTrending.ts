...
export const breakingNowCards: BreakingCard[] = [
  ...
  {
    id: 'b5',
    headline: 'On-device AI models ship on flagship phones',
    source: 'BBC News',
    timeAgo: '20m',
    topic: '#OnDeviceAI',
  ...
  {
    id: 'b6',
    headline: 'Cooling centers open early amid heat advisory',
    source: 'NPR',
    timeAgo: '1h',
    topic: '#HeatWave',
...
export const disguiseTrendingTopics: TrendingTopic[] = [
  ...
  },
  {
    ...
    changeLabel: 'Live',
    category: 'Tech',
    preview: 'Phone-sized models challenge cloud assistants',
    imageUrl: pulseNewsImages.chips,
  },
  {
    id: 't17',
    ...
    changeLabel: '+42%',
    category: 'Weather',
    preview: 'Cooling centers open early as temps spike',
    imageUrl: pulseNewsImages.earthTech,
  },
  {
    id: 't18',
    ...
    changeLabel: 'New',
    category: 'Local',
    preview: 'Sunday pedestrian pilots gain traction',
    imageUrl: pulseNewsImages.transit,
  },
  {
    id: 't19',
    ...
    changeLabel: '+17%',
    category: 'Culture',
    preview: 'Bookstores report summer reading surge',
    imageUrl: pulseNewsImages.newspaper,
  },
  {
    id: 't20',
    ...
    changeLabel: '+28%',
    category: 'Climate',
    preview: 'Battery prices unlock residential installs',
    imageUrl: pulseNewsImages.earthTech,
  },
];
...
export const editorsPicks = [
  ...
  {
    id: 'ep9',
    title: 'Car-free Sundays: what pilots mean for local shops',
    subtitle: 'Local desk · policy',
    topic: '#CarFreeCities',
  },
  {
    id: 'ep10',
    title: 'Heat wave survival: cooling centers & transit tips',
    subtitle: 'NPR · public health',
    topic: '#HeatWave',
  },
  {
    id: 'ep11',
    title: 'Indie bookstore summer list — staff picks',
    subtitle: 'BBC Culture · reading',
    topic: '#IndieBooks',
  },
  {
    id: 'ep12',
    title: 'Home solar in 2026: batteries get cheaper',
    subtitle: 'DW News · climate',
    topic: '#SolarHome',
  },
];
